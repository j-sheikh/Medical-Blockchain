...
class MyOwnPeer2PeerNode(Node):
    ...
    def chain_changed(self):
        text = f'USER {self.id} added something to the chain. Your chain needs to be updated.!'
        self.send_to_nodes(text)
        # my_new_block = self.chain.blockchain[-1]
        # self.send_to_nodes(my_new_block)